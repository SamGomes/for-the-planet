...
public class EndScreenFunctionalities : MonoBehaviour
{
    ...
    private PoppupScreenFunctionalities infoPoppupNeutralRef;
    ...
    {
        infoPoppupNeutralRef = new PoppupScreenFunctionalities(false, null, null, poppupPrefab, mainScene, this.GetComponent<MonoBehaviourFunctionalities>(), Resources.Load<Sprite>("Textures/UI/Icons/Info"), new Color(0.9f, 0.9f, 0.9f));
